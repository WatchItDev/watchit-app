...
export type ToggleCommentLikeMutation = { __typename?: 'Mutation', toggleCommentLike: boolean };
...
export type TogglePostLikeMutation = { __typename?: 'Mutation', togglePostLike: boolean };
...
export type GetAllPostsQuery = { __typename?: 'Query', getAllPosts: Array<{ __typename?: 'Post', id: string, visibility: VisibilitySetting, commentCount: number, likeCount: number, bookmarkCount: number, viewCount: number, updatedAt: number, createdAt: number, cid: string, description: string, title: string, author: { __typename?: 'User', address: string, username: string, displayName: string, bio: string }, media: Array<{ __typename?: 'MediaAttachment', id: string, type: string, url?: string | null, title?: string | null, cid: string }> }> };
...
export type GetIsCommentLikedQueryVariables = Exact<{
  commentId: Scalars['String']['input'];
}>;


export type GetIsCommentLikedQuery = { __typename?: 'Query', getIsCommentLiked: boolean };

export type GetIsPostLikedQueryVariables = Exact<{
  postId: Scalars['String']['input'];
}>;


export type GetIsPostLikedQuery = { __typename?: 'Query', getIsPostLiked: boolean };
...
export type GetPostsByAuthorQuery = { __typename?: 'Query', getPostsByAuthor: Array<{ __typename?: 'Post', visibility: VisibilitySetting, viewCount: number, updatedAt: number, likeCount: number, id: string, createdAt: number, commentCount: number, bookmarkCount: number, cid: string, description: string, title: string, media: Array<{ __typename?: 'MediaAttachment', id: string, type: string, title?: string | null, cid: string, url?: string | null }>, author: { __typename?: 'User', address: string, displayName: string } }> };
...
export type GetUserBookmarksQuery = { __typename?: 'Query', getUserBookmarks: Array<{ __typename?: 'Post', id: string, title: string, description: string, createdAt: number, media: Array<{ __typename?: 'MediaAttachment', url?: string | null, cid: string, title?: string | null, type: string }> }> };
...
export const GetIsFollowingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetIsFollowing"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"followerAddress"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"targetAddress"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getIsFollowing"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"followerAddress"},"value":{"kind":"Variable","name":{"kind":"Name","value":"followerAddress"}}},{"kind":"Argument","name":{"kind":"Name","value":"targetAddress"},"value":{"kind":"Variable","name":{"kind":"Name","value":"targetAddress"}}}]}]}}]} as unknown as DocumentNode<GetIsFollowingQuery, GetIsFollowingQueryVariables>;
export const GetIsCommentLikedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetIsCommentLiked"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"commentId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getIsCommentLiked"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"commentId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"commentId"}}}]}]}}]} as unknown as DocumentNode<GetIsCommentLikedQuery, GetIsCommentLikedQueryVariables>;
export const GetIsPostLikedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetIsPostLiked"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"postId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getIsPostLiked"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"postId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"postId"}}}]}]}}]} as unknown as DocumentNode<GetIsPostLikedQuery, GetIsPostLikedQueryVariables>;
