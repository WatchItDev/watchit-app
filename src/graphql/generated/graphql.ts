...
export type GetLeaderboardQuery = { __typename?: 'Query', getLeaderboard: Array<{ __typename?: 'User', address: string, email: string, xpTotal: number, xpBalance: number, username: string, displayName: string, currentRank: string }> };
