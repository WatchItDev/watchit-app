  ...
  return (
    <>
      <Box
        ...
        <Typography sx={{fontSize: "clamp(1.5rem, 1vw, 3rem)", fontWeight: "bold"}} variant="body2">
          {title}
        </Typography>
      ...
      <CardContent
        ...
        <Box style={{width: "100%", height: "25%"}}>
          <Image
            ...
            src={data[currentIndex].images.vertical}
            ratio="21/9"
          />
        </Box>
        ...
        <Stack direction="row" spacing={1} alignItems="center">
          ...
          <Typography sx={{fontSize: "clamp(0.3rem, 1vw, 0.7rem)"}} variant="body2">
