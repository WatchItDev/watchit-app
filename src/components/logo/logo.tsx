    ...
    const logo = (
      ...
      >
        <svg width="100%" height="100%" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <linearGradient id="paint0_linear_1612_200696" x1="374.28" y1="367.964" x2="482.143" y2="277.564"
                            gradientUnits="userSpaceOnUse">
              <stop stopColor={PRIMARY_DARK} />
              <stop offset="1" stopColor={PRIMARY_MAIN} />
            </linearGradient>
            <linearGradient id="paint1_linear_1612_200696" x1="440.049" y1="419" x2="440.049" y2="94.5645"
                            gradientUnits="userSpaceOnUse">
              <stop stopColor={PRIMARY_LIGHT} />
              <stop offset="1" stopColor={PRIMARY_MAIN} />
            </linearGradient>
            <linearGradient id="paint2_linear_1612_200696" x1="137.908" y1="368.109" x2="29.8215" y2="277.6"
                            gradientUnits="userSpaceOnUse">
              <stop stopColor={PRIMARY_LIGHT} />
              <stop offset="1" stopColor={PRIMARY_MAIN} />
            </linearGradient>
