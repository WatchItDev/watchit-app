...
import Image from "@/render/package/components/Image";
import MainLoader from '@/render/package/components/MainLoader';
import VideoModal from "@/render/package/components/VideoModal";
...
export const MovieDetails = (props) => {
  ...
  return (
    !ready && <MainLoader /> ||
    <MovieDetailsContainer sx={{ borderTopLeftRadius: process.env.WATCHIT_RUNTIME === 'web' ? '0' : '1rem' }}>
