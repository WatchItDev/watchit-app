...
import Details from '@/render/package/components/MovieDetails';
import MainLoader from '@/render/package/components/MainLoader';
import CatalogList from '@/render/package/components/Catalog';
import MoviePlayer from "@/render/package/components/MoviePlayer";
import EmptyBlankSlate from "@/render/package/components/Blankslate";
import ChannelsMenu from "@/render/package/components/ChannelsMenu";
import BlockedBlankslate from "@/render/package/components/BlockedBlankslate";
  ...
  return (
    <MainContainer>
      ...
      <MainContent
        ref={moviesWrapper}
        sx={{
          borderTopLeftRadius: import.meta.env.WATCHIT_RUNTIME === 'web' ? '0' : '1rem'
        }}
      >
        {isAdding ? (
