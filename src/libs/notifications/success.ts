...
export const SUCCESS_MESSAGES: Record<SUCCESS, string> = {
  ...
  [SUCCESS.INVITATIONS_SUCCESSFULLY]:
    'The email invitation was sent successfully.',
  ...
  [SUCCESS.TIP_CREATED_SUCCESSFULLY]:
    'Thanks for your tip! Your support fuels more creations.',
  [SUCCESS.FOLLOW_UNFOLLOW_SUCCESSFULLY]:
    'Successfully {profileName} {actionLbl}.',
  [SUCCESS.PROFILE_JOINED_SUCCESSFULLY]: 'Successfully joined the profile.',
  [SUCCESS.OWNERSHIP_REGISTERED_SUCCESSFULLY]:
    'Asset {count} successfully processed',
  ...
  [SUCCESS.CAMPAIGN_CONFIGURED_SUCCESSFULLY]:
    'Campaign configured successfully!',
  [SUCCESS.CAMPAIGN_WITHDRAWN_SUCCESSFULLY]:
    'Funds withdrawn from campaign successfully!',
};
