...
describe("[COMPONENTS] <FinanceDepositFromStripe /> ", () => {
  ...
  it("should render the component correctly", () => {
    ...
    expect(
      screen.getByText("We’re working hard to bring this feature to life. Check back soon!"),
    ).toBeInTheDocument();
  });

  it("should have the correct styles", () => {
    renderComponent();
    const boxElement = screen.getByText(/This feature is coming soon/i).closest("div");
