...
// import GovernanceCommentForm from '../governance-comment-form';
//
// import { ProposalsMockList, proposalVotes } from '../governance-mock';
// import Label from '../../../components/label';
// import Header from '../../../layouts/dashboard/header';
// import { useResponsive } from '../../../hooks/use-responsive';
...
//
//   //
//   // const renderSkeleton = <GovernanceDetailsSkeleton />;
//   //
//   // const renderError = (
//   //   <EmptyContent
//   //     filled
...
//       <Grid xs={12} md={4} sx={{ pl: 2 }}>
//         <Box sx={{ position: 'sticky', top: '75px' }}>
//           <Card component={m.div} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} sx={{ backgroundColor: '#2B2D31' }}>
//             <CardContent>
//               <Typography variant="h6">Resultados de la Votación</Typography>
//               <Stack spacing={2} sx={{ mt: 2 }}>
//                 <Typography variant="body2">A Favor ({proposalVotes.results.forVotes} MMC)</Typography>
//                 <LinearProgress variant="determinate" value={(proposalVotes.results.forVotes / proposalVotes.totalVotes) * 100} color="primary" />
//
//                 <Typography variant="body2">En Contra ({proposalVotes.results.againstVotes} MMC)</Typography>
//                 <LinearProgress variant="determinate" value={(proposalVotes.results.againstVotes / proposalVotes.totalVotes) * 100} color="error" />
//
//                 <Typography variant="body2">Abstención ({proposalVotes.results.abstainVotes} MMC)</Typography>
//                 <LinearProgress variant="determinate" value={(proposalVotes.results.abstainVotes / proposalVotes.totalVotes) * 100} color="warning" />
//               </Stack>
//
//               <Divider sx={{ my: 3 }} />
//
//               <Typography variant="h6">Emitir tu Voto</Typography>
//               {post.publish === 'active' ? (
//                 <Stack spacing={2} sx={{ mt: 2 }}>
//                   <Button variant="contained" color="primary" startIcon={<Iconify icon="eva:checkmark-circle-2-outline" />}>
//                     Votar A Favor
//                   </Button>
//                   <Button variant="contained" color="error" startIcon={<Iconify icon="eva:close-circle-outline" />}>
//                     Votar En Contra
//                   </Button>
//                   <Button variant="contained" color="warning" startIcon={<Iconify icon="eva:minus-circle-outline" />}>
//                     Abstenerse
//                   </Button>
//                 </Stack>
//               ) : (
...
//               <Divider sx={{ my: 3 }} />
//
//               <Typography variant="h6">Votos</Typography>
//               <Stack spacing={2} sx={{ mt: 2 }}>
//                 {proposalVotes.votes.map((vote, index) => (
...
//                       <Typography variant="body2">{truncateAddress(vote.user)}</Typography>
//                     </Box>
//                     <Typography variant="body2">{fShortenNumber(vote.amount)} MMC</Typography>
//                   </Box>
//                 ))}
//               </Stack>
//             </CardContent>
...
//           {/*    <Typography variant="h6">Voting Results</Typography> */}
//           {/*    <Stack spacing={1}> */}
//           {/*      <Typography variant="body2">For: {fShortenNumber(proposalVotes.results.for)} MMC</Typography> */}
//           {/*      <Typography variant="body2">Against: {fShortenNumber(proposalVotes.results.against)} MMC</Typography> */}
//           {/*      <Typography variant="body2">Abstain: {fShortenNumber(proposalVotes.results.abstain)} MMC</Typography> */}
//           {/*    </Stack> */}
//
//           {/*    <Divider sx={{ my: 2 }} /> */}
//
...
//           {/*          <Typography variant="body2">{vote.user}</Typography> */}
//           {/*          <Typography variant="body2">{fShortenNumber(vote.amount)} MMC</Typography> */}
//           {/*        </Box> */}
//           {/*      ))} */}
//           {/*    </Stack> */}
