...
import MovieTableFiltersResult from '../movie-table-filters-result';
...
export default function MovieListView() {
  ...
  const handleEditRow = useCallback(
    (id: string) => {
      router.push(paths.dashboard.movie.edit(id));
    },
    [router]
  );
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.dashboard.movie.new}
              variant="contained"
