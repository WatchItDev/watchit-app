...
export default function PublicationDetailsDiscussion() {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', margin: '20px 0', width: '100%' }}>
            <Box>
              ...
              >
                ...
                <Typography
                  sx={{
                    fontSize: 'clamp(0.1rem, 0.8vw, 2rem)',
                    whiteSpace: 'nowrap',
                    margin: '10px 0',
                  }}
                  variant="body2"
                ...
                <Button
                  sx={{ background: '#FFFFFF', padding: '5px', minWidth: '0', borderRadius: '50%' }}
                  variant="contained"
                >
            ...
            <Box
              sx={{ display: 'flex', flexDirection: 'column', padding: '0px 10px', width: '90%' }}
            >
              <Typography
                style={{ fontSize: 'clamp(1.5rem, 1vw, 3rem)' }}
                noWrap
                variant="h6"
                sx={{ mb: 1 }}
              >
              ...
              <Stack
                sx={{ overflow: 'hidden', flexDirection: 'column', width: '100%' }}
                direction="row"
                spacing={1}
                alignItems="center"
              >
                <Typography sx={{ fontSize: 'clamp(1rem, 0.8vw, 2rem)' }} variant="body2">
                  The movie Edge of Tomorrow has an ending that has left many viewers divided. Some
                  believe that the conclusion is satisfying and ties up the story well, while others
                  think it is confusing and does not resolve all the questions posed throughout the
                  film. What do you think about the ending? Do you believe it makes sense within the
                ...
                >
                  <Box style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Typography
                      sx={{ fontSize: 'clamp(0.1rem, 0.8vw, 2rem)', whiteSpace: 'nowrap' }}
                      variant="body2"
                    >
                      3 Hours ago
                    </Typography>
      ...
      <Box sx={{ width: '30%' }}>
        ...
        >
          <Box sx={{ textAlign: 'center', fontWeight: 'bold' }}>Want to be a movie influencer?</Box>
          <Box>
            <Button
              variant="contained"
              sx={{
