...
const PublicationWizardContentLayout: FC<PropsWithChildren<MovieWizardContentLayoutProps>> = ({ children, data, showNext, disableNext = false, showBack, nextText = 'Continue', onNext, onBack }) => (
