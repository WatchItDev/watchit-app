...
import PublicationList from '../publication-list.tsx';
import PublicationSort from '../publication-sort.tsx';
import PublicationSearch from '../publication-search.tsx';
import PublicationFilters from '../publication-filters.tsx';
import PublicationFiltersResult from '../publication-filters-result.tsx';
...
export default function PublicationShopView() {
  ...
  const renderFilters = (
    ...
    >
      <PublicationSearch
        ...
        hrefItem={(id: string) => paths.publication.details(id)}
      />
  ...
  return (
    ...
    >
      ...
      <PublicationList products={dataFiltered} loading={productsLoading} />
    </Container>
  );
}
