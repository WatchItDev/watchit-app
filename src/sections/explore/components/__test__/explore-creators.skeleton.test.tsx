...
vi.mock('@src/sections/explore/components/explore-carousel.skeleton', () => ({
  ExploreCarouselSkeleton: vi.fn(() => (
    <div data-testid="explore-carousel-skeleton" />
  )),
}));
...
describe('Testing in the <ExploreCreatorsSkeleton/>', () => {
  ...
  it('should fail if ExploreCarouselSkeleton is not rendered', () => {
    vi.doMock(
      '@src/sections/explore/components/explore-carousel.skeleton',
      () => ({
    ...
    unmount();
    expect(
      screen.queryByTestId('explore-carousel-skeleton'),
